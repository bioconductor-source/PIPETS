...
only three parameters that need to be specified to run PIPETS 
are `inputBedFile`, the expected `readLength`, and the prefix for the output 
file name `OutputFileID`. 

```{r echo=TRUE, message=FALSE, eval=FALSE}

library(PIPETS)

PIPETS_FullRun(inputBedFile = "~/path/to/bed/file", readLength = 58, 
               OutputFileID = "ExampleResultsRun")
